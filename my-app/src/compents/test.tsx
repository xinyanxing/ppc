...
// 函数接口类型
type SearchFn = (source: string, subString: string) => boolean;
// 索引类型
...
const greeter = new Greeter('消息消息消息');
...
const animal = new Animal('Goat', 'bb');
...
const greeterMaker: typeof Greeters = Greeters;

const greeter2: Greeters = new greeterMaker();
...
export class Hello extends React.Component<HelloProps, {}> {
  ...
  createSquare = (config: SquareConfig): { color: string; area: number } => {
    const newSquare = { color: 'ssss', area: 100 };
    return newSquare;
  };
